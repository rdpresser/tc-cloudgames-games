namespace TC.CloudGames.Games.Unit.Tests.Shared
{
    public class BaseTest : TestBase
    {
        ...
        protected static IEnumerable<(string Identifier, int Count, IEnumerable<string> ErrorCodes)> GroupValidationErrorsByIdentifier(IEnumerable<FluentValidation.Results.ValidationFailure> errors)
        {
            return errors
