...
namespace TC.CloudGames.Games.Unit.Tests.Api.Abstractions;

public class App : AppFixture<Games.Api.Program>
{
    public App()
    {
    ...
    protected override void ConfigureServices(IServiceCollection s)
    {
        ...
        s.RemoveAll<IGameRepository>();
        s.AddSingleton<IGameRepository, Fakes.FakeGameRepository>();
        ...
        s.RemoveAll<ILogger<CreateGameCommandHandler>>();
        s.AddSingleton(sp => A.Fake<ILogger<CreateGameCommandHandler>>());
    }
